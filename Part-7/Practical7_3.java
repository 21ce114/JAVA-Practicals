...
AIM :Personal Loan Eligibility Criteria for Salaried 
Applicant is as follows:
Eligible Age Group - 21 years to 60 years
Minimum Net Monthly Income - Rs. 15,000
Minimum Total Work Experience - 1 year
Citizenship – Indian
Create a class AccountHolder to store above given information
 entered by a user. Create 5 objects of AccountHolder class and 
 store them in an ArrayList. Display names of account holders
, who are eligible to get a loan based on given criteria.
*/
...
class AccountHolder {
    ...
    boolean checkEligibility() {
        if ((age >= 21 && age <= 60) && (monthlyIncome >= 15000) && (workExperience >= 1) && (citizenship == "Indian")) {
            return true;
        } else {
            return false;
        }
...
public class Practical7_3 {
    public static void main(String[] args) {
        ...
        AccountHolder a3 = new AccountHolder(21, 20000, 1, "AccountHolder2", "Kazakistan");
        AccountHolder a4 = new AccountHolder(25, 25000, 0, "AccountHolder3", "Morocco");
